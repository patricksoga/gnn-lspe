...
#python3 configure_tests.py --config ../configs/GatedGCN_ZINC_LSPE_withLapEigLoss.json --pe_init gape --n_gape 1 --job_note lspe-eigloss-ngape1-rwk --param_values 4 6 8 16 32 --matrix_type RWK
